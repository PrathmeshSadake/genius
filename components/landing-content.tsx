  ...
  return (
    <div className='px-10 pb-20'>
      ...
      <section className='relative isolate overflow-hidden bg-gray-900 px-6 py-24 sm:py-32 lg:px-8'>
        ...
        <div className='absolute inset-y-0 right-1/2 -z-10 mr-16 w-[200%] origin-bottom-left skew-x-[-30deg] bg-gray-950 shadow-xl shadow-indigo-600/10 ring-1 ring-indigo-50 sm:mr-28 lg:mr-0 xl:mr-16 xl:origin-center' />
        <div className='mx-auto max-w-2xl lg:max-w-4xl'>
          ...
          <figure className='mt-10'>
            <blockquote className='text-center text-xl font-semibold leading-8 text-gray-100 sm:text-2xl sm:leading-9'>
              <p>
                This is the best application I've ever used. This app has
                changed my life, cannot imagine working without it, definitely
